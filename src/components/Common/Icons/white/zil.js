...
const SvgZil = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props}>
    <g fill="#fff">
      ...
      <path d="M9 7.281l11.114 5.383 2.845-1.282L11.891 6z" fillOpacity={0.3} />
      <path d="M20.114 12.651l2.845-1.281v2.865l-2.845 1.281zm0 13.284v-8.937l2.845-1.295v8.951z" fillOpacity={0.65} />
    </g>
  </svg>
);
