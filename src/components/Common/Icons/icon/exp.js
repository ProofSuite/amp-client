...
const SvgExp = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props}>
    <defs>
      <linearGradient id="exp_svg__c" x1="50%" x2="50%" y1="0%" y2="100%">
        <stop offset="0%" stopColor="#FFF" stopOpacity={0.5} />
        <stop offset="100%" stopOpacity={0.5} />
      </linearGradient>
      <circle id="exp_svg__b" cx={16} cy={15} r={15} />
      <filter id="exp_svg__a" width="111.7%" height="111.7%" x="-5.8%" y="-4.2%" filterUnits="objectBoundingBox">
      ...
      />
      <filter id="exp_svg__d" width="117.5%" height="115.9%" x="-8.8%" y="-5.7%" filterUnits="objectBoundingBox">
        <feOffset dy={0.5} in="SourceAlpha" result="shadowOffsetOuter1" />
        <feGaussianBlur in="shadowOffsetOuter1" result="shadowBlurOuter1" stdDeviation={0.5} />
    ...
    <g fill="none" fillRule="evenodd">
      <use fill="#000" filter="url(#exp_svg__a)" xlinkHref="#exp_svg__b" />
      <use fill="#FFAA5C" xlinkHref="#exp_svg__b" />
      <use
        fill="url(#exp_svg__c)"
        style={{
      ...
      <use fill="#000" filter="url(#exp_svg__d)" xlinkHref="#exp_svg__e" />
      <use fill="#FFF" xlinkHref="#exp_svg__e" />
    </g>
  </svg>
);
