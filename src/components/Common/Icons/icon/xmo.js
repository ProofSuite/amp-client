...
const SvgXmo = props => (
  <svg width={64} height={64} {...props}>
    <defs>
      ...
      <filter x="-5.8%" y="-4.2%" width="111.7%" height="111.7%" filterUnits="objectBoundingBox" id="xmo_svg__a">
    ...
    <g fill="none">
      ...
      <g fill="#FFF">
        ...
        <path d="M23.193 6.681L16 13.866 10.517 8.39l-1.71-1.71A10.915 10.915 0 0 1 16 4c2.75 0 5.26 1.005 7.193 2.681" />
      </g>
    </g>
  </svg>
);
