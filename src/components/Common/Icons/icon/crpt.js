...
const SvgCrpt = props => (
  <svg width={64} height={64} {...props}>
    <defs>
      ...
      <filter id="crpt_svg__a" width="111.7%" height="111.7%" x="-5.8%" y="-4.2%" filterUnits="objectBoundingBox">
