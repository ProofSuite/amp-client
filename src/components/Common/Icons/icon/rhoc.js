...
const SvgRhoc = props => (
  <svg width={64} height={64} {...props}>
    <defs>
      ...
      <filter id="rhoc_svg__a" width="111.7%" height="111.7%" x="-5.8%" y="-4.2%" filterUnits="objectBoundingBox">
      ...
      />
      <filter id="rhoc_svg__d" width="115%" height="119.4%" x="-7.5%" y="-6.9%" filterUnits="objectBoundingBox">
        <feOffset dy={0.5} in="SourceAlpha" result="shadowOffsetOuter1" />
        <feGaussianBlur in="shadowOffsetOuter1" result="shadowBlurOuter1" stdDeviation={0.5} />
