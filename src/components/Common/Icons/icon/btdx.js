...
const SvgBtdx = props => (
  <svg width={64} height={64} {...props}>
    <defs>
      ...
      <filter x="-5.8%" y="-4.2%" width="111.7%" height="111.7%" filterUnits="objectBoundingBox" id="btdx_svg__a">
