...
const SvgEqli = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props}>
    <defs>
      ...
      <filter id="eqli_svg__a" width="111.7%" height="111.7%" x="-5.8%" y="-4.2%" filterUnits="objectBoundingBox">
