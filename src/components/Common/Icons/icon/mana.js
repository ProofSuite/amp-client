...
const SvgMana = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props}>
    <defs>
      <linearGradient id="mana_svg__c" x1="50%" x2="50%" y1="0%" y2="100%">
        <stop offset="0%" stopColor="#FFF" stopOpacity={0.5} />
        <stop offset="100%" stopOpacity={0.5} />
      </linearGradient>
      <circle id="mana_svg__b" cx={16} cy={15} r={15} />
      <filter id="mana_svg__a" width="111.7%" height="111.7%" x="-5.8%" y="-4.2%" filterUnits="objectBoundingBox">
    ...
    <g fill="none">
      ...
      <use fill="#BFB5AF" fillRule="evenodd" xlinkHref="#mana_svg__b" />
      <use
      ...
      <use fill="#000" filter="url(#mana_svg__d)" xlinkHref="#mana_svg__e" />
      <use fill="#FFF" fillRule="evenodd" xlinkHref="#mana_svg__e" />
    </g>
  </svg>
);
