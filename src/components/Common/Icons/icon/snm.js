...
const SvgSnm = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props}>
    <defs>
      <linearGradient id="snm_svg__c" x1="50%" x2="50%" y1="0%" y2="100%">
        <stop offset="0%" stopColor="#FFF" stopOpacity={0.5} />
        <stop offset="100%" stopOpacity={0.5} />
      </linearGradient>
      <circle id="snm_svg__b" cx={16} cy={15} r={15} />
      <filter id="snm_svg__a" width="111.7%" height="111.7%" x="-5.8%" y="-4.2%" filterUnits="objectBoundingBox">
    ...
    <g fill="none">
      <use fill="#000" filter="url(#snm_svg__a)" xlinkHref="#snm_svg__b" />
      <use fill="#0B1C26" fillRule="evenodd" xlinkHref="#snm_svg__b" />
      <use
        fill="url(#snm_svg__c)"
        fillRule="evenodd"
        style={{
        ...
        xlinkHref="#snm_svg__b"
      />
      <circle cx={16} cy={15} r={14.5} stroke="#000" strokeOpacity={0.097} />
      <use fill="#000" filter="url(#snm_svg__d)" xlinkHref="#snm_svg__e" />
