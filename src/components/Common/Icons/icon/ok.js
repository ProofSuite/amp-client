...
const SvgOk = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props}>
    <defs>
      <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="ok_svg__c">
        <stop stopColor="#FFF" stopOpacity={0.5} offset="0%" />
        <stop stopOpacity={0.5} offset="100%" />
      </linearGradient>
      <circle id="ok_svg__b" cx={15} cy={15} r={15} />
      <filter x="-5.8%" y="-4.2%" width="111.7%" height="111.7%" filterUnits="objectBoundingBox" id="ok_svg__a">
    ...
    <g fill="none">
      <g transform="translate(1)">
        <use fill="#000" filter="url(#ok_svg__a)" xlinkHref="#ok_svg__b" />
        <use fill="#000" xlinkHref="#ok_svg__b" />
        <use
          fill="url(#ok_svg__c)"
          style={{
