...
const SvgAgrs = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props}>
    <defs>
      ...
      <filter id="agrs_svg__a" width="111.7%" height="111.7%" x="-5.8%" y="-4.2%" filterUnits="objectBoundingBox">
      ...
      />
      <filter id="agrs_svg__d" width="119.4%" height="121.9%" x="-9.7%" y="-7.8%" filterUnits="objectBoundingBox">
        <feOffset dy={0.5} in="SourceAlpha" result="shadowOffsetOuter1" />
        <feGaussianBlur in="shadowOffsetOuter1" result="shadowBlurOuter1" stdDeviation={0.5} />
