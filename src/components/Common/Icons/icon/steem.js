...
const SvgSteem = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props}>
    <defs>
      ...
      <filter id="steem_svg__a" width="111.7%" height="111.7%" x="-5.8%" y="-4.2%" filterUnits="objectBoundingBox">
      ...
      />
      <filter id="steem_svg__d" width="119%" height="117.7%" x="-9.5%" y="-6.3%" filterUnits="objectBoundingBox">
        <feOffset dy={0.5} in="SourceAlpha" result="shadowOffsetOuter1" />
        <feGaussianBlur in="shadowOffsetOuter1" result="shadowBlurOuter1" stdDeviation={0.5} />
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <g fillRule="nonzero">
        <use fill="#000" filter="url(#steem_svg__d)" xlinkHref="#steem_svg__e" />
