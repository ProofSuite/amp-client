...
const SvgMith = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props}>
    ...
    <g fill="none" fillRule="evenodd">
      <use fill="#000" filter="url(#mith_svg__a)" xlinkHref="#mith_svg__b" />
      <use fill="#00316D" xlinkHref="#mith_svg__b" />
      <use
        fill="url(#mith_svg__c)"
        style={{
          mixBlendMode: 'soft-light',
        }}
        xlinkHref="#mith_svg__b"
      />
      <circle cx={16} cy={15} r={14.5} stroke="#000" strokeOpacity={0.097} />
      <g fillRule="nonzero">
        <use fill="#000" filter="url(#mith_svg__d)" xlinkHref="#mith_svg__e" />
        <use fill="#FFF" fillRule="evenodd" xlinkHref="#mith_svg__e" />
      </g>
    </g>
  </svg>
);
