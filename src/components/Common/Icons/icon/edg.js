...
const SvgEdg = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props}>
    <defs>
      <linearGradient id="edg_svg__c" x1="50%" x2="50%" y1="0%" y2="100%">
        <stop offset="0%" stopColor="#FFF" stopOpacity={0.5} />
        <stop offset="100%" stopOpacity={0.5} />
      </linearGradient>
      <circle id="edg_svg__b" cx={16} cy={15} r={15} />
      <filter id="edg_svg__a" width="111.7%" height="111.7%" x="-5.8%" y="-4.2%" filterUnits="objectBoundingBox">
      ...
      />
      <filter id="edg_svg__d" width="119.5%" height="117.5%" x="-9.7%" y="-6.3%" filterUnits="objectBoundingBox">
        <feOffset dy={0.5} in="SourceAlpha" result="shadowOffsetOuter1" />
        <feGaussianBlur in="shadowOffsetOuter1" result="shadowBlurOuter1" stdDeviation={0.5} />
    ...
    <g fill="none" fillRule="evenodd">
      <use fill="#000" filter="url(#edg_svg__a)" xlinkHref="#edg_svg__b" />
      <use fill="#2B1544" xlinkHref="#edg_svg__b" />
      <use
        fill="url(#edg_svg__c)"
        style={{
      ...
      <g fillRule="nonzero">
        <use fill="#000" filter="url(#edg_svg__d)" xlinkHref="#edg_svg__e" />
        <use fill="#FFF" fillRule="evenodd" xlinkHref="#edg_svg__e" />
      </g>
    </g>
  </svg>
);

export default SvgEdg;
