...
const SvgAda = props => (
  <svg width={64} height={64} {...props}>
    ...
    <g fill="none">
      ...
      <use fill="#000" filter="url(#ada_svg__d)" xlinkHref="#ada_svg__e" />
      <use fill="#FFF" xlinkHref="#ada_svg__e" />
    </g>
  </svg>
);
