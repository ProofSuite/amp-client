...
const SvgApex = props => (
  <svg width={64} height={64} {...props}>
    <defs>
      ...
      <filter id="apex_svg__a" width="111.7%" height="111.7%" x="-5.8%" y="-4.2%" filterUnits="objectBoundingBox">
      ...
      <path
        id="apex_svg__e"
        d="M6 18.25L16 5.5l10 12.75v4.25L16 9.75 6 22.5v-4.25zm10.5 1.25a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5z"
      />
      <filter id="apex_svg__d" width="117.5%" height="120.6%" x="-8.8%" y="-7.4%" filterUnits="objectBoundingBox">
        <feOffset dy={0.5} in="SourceAlpha" result="shadowOffsetOuter1" />
        <feGaussianBlur in="shadowOffsetOuter1" result="shadowBlurOuter1" stdDeviation={0.5} />
