...
const SvgBcd = props => (
  <svg width={64} height={64} {...props}>
    <defs>
      ...
      <filter id="bcd_svg__a" width="111.7%" height="111.7%" x="-5.8%" y="-4.2%" filterUnits="objectBoundingBox">
      ...
      <path
        id="bcd_svg__e"
        d="M22.585 8.694l.077.171-3.054 1.402 1.374 4.55 4.521-2.283.06.119.018-.022-2.929-3.906-.067-.031zm-.165-.077l-2.773-1.29h-7.171l-2.962 1.36 3.08 1.296h6.85l2.976-1.366zm-13.154.32l-2.773 3.601 4.514 2.28 1.38-4.568-3.12-1.313zm3.44 1.373l-1.425 4.72 4.713 8.332 4.714-8.332-1.426-4.72h-6.576zm12.512 2.733L21 15.174l-4.205 7.433 8.424-9.564zm-10.047 9.524l-4.182-7.393-4.196-2.119 8.378 9.512zm-8.74-9.924l.033-.067-.043.056.01.011zm2.791-4.181L12.405 7h7.312l3.144 1.462L26 12.648 16 24 6 12.646l3.222-4.184zm9.201 5.372c.059.607-.192.972-.594 1.179.661.16 1.075.558.993 1.45-.1 1.106-.915 1.402-2.079 1.47v1.163h-.692v-1.147c-.18 0-.363-.002-.553-.006v1.153h-.691V17.93c-.162-.001-.327-.004-.495-.004h-.9l.137-.837s.512.008.503 0c.196 0 .248-.143.26-.232V15.02h.074a.55.55 0 0 0-.074-.005v-1.311c-.026-.143-.117-.307-.398-.308.009-.01-.502 0-.502 0v-.748h.954v.004c.144 0 .29-.003.44-.006v-1.151h.693v1.129c.184-.004.37-.008.552-.008v-1.12l.692-.001v1.151c.894.08 1.601.358 1.68 1.188zm-.968 2.49c0-.908-1.471-.771-1.94-.771v1.543c.469 0 1.94.098 1.94-.772zm-.322-2.177c0-.826-1.228-.7-1.618-.7v1.4c.39 0 1.618.092 1.618-.7z"
      />
      <filter id="bcd_svg__d" width="117.5%" height="120.6%" x="-8.8%" y="-7.4%" filterUnits="objectBoundingBox">
        <feOffset dy={0.5} in="SourceAlpha" result="shadowOffsetOuter1" />
        <feGaussianBlur in="shadowOffsetOuter1" result="shadowBlurOuter1" stdDeviation={0.5} />
