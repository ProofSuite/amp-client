...
const SvgCloak = props => (
  <svg width={64} height={64} {...props}>
    <defs>
      ...
      <filter id="cloak_svg__a" width="111.7%" height="111.7%" x="-5.8%" y="-4.2%" filterUnits="objectBoundingBox">
      ...
      />
      <filter id="cloak_svg__d" width="115.9%" height="115.9%" x="-8%" y="-5.7%" filterUnits="objectBoundingBox">
        <feOffset dy={0.5} in="SourceAlpha" result="shadowOffsetOuter1" />
        <feGaussianBlur in="shadowOffsetOuter1" result="shadowBlurOuter1" stdDeviation={0.5} />
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <g fillRule="nonzero">
        <use fill="#000" filter="url(#cloak_svg__d)" xlinkHref="#cloak_svg__e" />
