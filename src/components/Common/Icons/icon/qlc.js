...
const SvgQlc = props => (
  <svg width={64} height={64} {...props}>
    <defs>
      <linearGradient id="qlc_svg__c" x1="50%" x2="50%" y1="0%" y2="100%">
        <stop offset="0%" stopColor="#FFF" stopOpacity={0.5} />
        <stop offset="100%" stopOpacity={0.5} />
      </linearGradient>
      <circle id="qlc_svg__b" cx={16} cy={15} r={15} />
      <filter id="qlc_svg__a" width="111.7%" height="111.7%" x="-5.8%" y="-4.2%" filterUnits="objectBoundingBox">
    ...
    <g fill="none" fillRule="evenodd">
      <g fillRule="nonzero">
        <use fill="#000" filter="url(#qlc_svg__a)" xlinkHref="#qlc_svg__b" />
        <use fill="#610089" fillRule="evenodd" xlinkHref="#qlc_svg__b" />
        <use
          fill="url(#qlc_svg__c)"
          fillRule="evenodd"
          style={{
          ...
          xlinkHref="#qlc_svg__b"
        />
        <circle cx={16} cy={15} r={14.5} stroke="#000" strokeOpacity={0.097} />
      </g>
      <use fill="#000" filter="url(#qlc_svg__d)" xlinkHref="#qlc_svg__e" />
