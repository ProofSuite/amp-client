...
const SvgCc = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props}>
    <defs>
      ...
      <circle id="cc_svg__b" cx={15} cy={15} r={15} />
      <filter x="-5.8%" y="-4.2%" width="111.7%" height="111.7%" filterUnits="objectBoundingBox" id="cc_svg__a">
    ...
    <g fill="none" fillRule="evenodd">
      <g transform="translate(1)" fillRule="nonzero">
        <use fill="#000" filter="url(#cc_svg__a)" xlinkHref="#cc_svg__b" />
        <use fill="#36B0F3" xlinkHref="#cc_svg__b" />
        <use
          fill="url(#cc_svg__c)"
          style={{
