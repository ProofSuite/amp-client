...
const SvgBtx = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props}>
    <defs>
      <linearGradient id="btx_svg__c" x1="50%" x2="50%" y1="0%" y2="100%">
        <stop offset="0%" stopColor="#FFF" stopOpacity={0.5} />
        <stop offset="100%" stopOpacity={0.5} />
      </linearGradient>
      <circle id="btx_svg__b" cx={16} cy={15} r={15} />
      <filter id="btx_svg__a" width="111.7%" height="111.7%" x="-5.8%" y="-4.2%" filterUnits="objectBoundingBox">
    ...
    <g fill="none" fillRule="evenodd">
      <use fill="#000" filter="url(#btx_svg__a)" xlinkHref="#btx_svg__b" />
      <use fill="#FB2EA3" xlinkHref="#btx_svg__b" />
      <use
        fill="url(#btx_svg__c)"
        style={{
          mixBlendMode: 'soft-light',
        }}
        xlinkHref="#btx_svg__b"
      />
      <circle cx={16} cy={15} r={14.5} stroke="#000" strokeOpacity={0.097} />
      <g fillRule="nonzero">
        <use fill="#000" filter="url(#btx_svg__d)" xlinkHref="#btx_svg__e" />
        <use fill="#FFF" fillRule="evenodd" xlinkHref="#btx_svg__e" />
      </g>
    </g>
  </svg>
);
