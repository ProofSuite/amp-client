...
const SvgTrig = props => (
  <svg width={64} height={64} {...props}>
    <defs>
      <linearGradient id="trig_svg__c" x1="50%" x2="50%" y1="0%" y2="100%">
        <stop offset="0%" stopColor="#FFF" stopOpacity={0.5} />
        <stop offset="100%" stopOpacity={0.5} />
      </linearGradient>
      <circle id="trig_svg__b" cx={16} cy={15} r={15} />
      <filter id="trig_svg__a" width="111.7%" height="111.7%" x="-5.8%" y="-4.2%" filterUnits="objectBoundingBox">
      ...
      />
      <filter id="trig_svg__d" width="119.4%" height="117.5%" x="-9.7%" y="-6.2%" filterUnits="objectBoundingBox">
        <feOffset dy={0.5} in="SourceAlpha" result="shadowOffsetOuter1" />
        <feGaussianBlur in="shadowOffsetOuter1" result="shadowBlurOuter1" stdDeviation={0.5} />
    ...
    <g fill="none" fillRule="evenodd">
      <use fill="#000" filter="url(#trig_svg__a)" xlinkHref="#trig_svg__b" />
      <use fill="#30C0F2" xlinkHref="#trig_svg__b" />
      <use
        fill="url(#trig_svg__c)"
        style={{
          mixBlendMode: 'soft-light',
        }}
        xlinkHref="#trig_svg__b"
      />
      <circle cx={16} cy={15} r={14.5} stroke="#000" strokeOpacity={0.097} />
      <g fillRule="nonzero">
        <use fill="#000" filter="url(#trig_svg__d)" xlinkHref="#trig_svg__e" />
        <use fill="#FFF" fillRule="evenodd" xlinkHref="#trig_svg__e" />
      </g>
    </g>
  </svg>
);
